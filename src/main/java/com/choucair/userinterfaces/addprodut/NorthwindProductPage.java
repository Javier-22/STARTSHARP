...
public class NorthwindProductPage {
    ...
    public static  final Target MAX=Target.the(" ").locatedBy("//*[@id='s-Page']/div[4]/div[1]/button[2]/i");
    ...
    public static  final Target SAVEBUTTONPRODUC=Target.the("save product").located(By.cssSelector("span.button-inner>i.fa.fa-check-circle.text-purple"));
